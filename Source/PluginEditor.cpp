...
//==============================================================================
Juce_filterAudioProcessorEditor::Juce_filterAudioProcessorEditor (Juce_filterAudioProcessor& p)
...
Juce_filterAudioProcessorEditor::~Juce_filterAudioProcessorEditor()
{
}

//==============================================================================
void Juce_filterAudioProcessorEditor::paint (juce::Graphics& g)
{
...
void Juce_filterAudioProcessorEditor::resized()
{
...
void Juce_filterAudioProcessorEditor::parameterValueChanged(int parameterIndex, float newValue)
{
    parametersChanged.set(true);
}

void Juce_filterAudioProcessorEditor::timerCallback()
{
...
std::vector<juce::Component*> Juce_filterAudioProcessorEditor::getComps()
{
    return
    {
        &peakFreqSlider,
